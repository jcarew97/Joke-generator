      ...
      <div className="mt-8 sm:mx-auto w-full max-w-md">
        <div className="bg-white dark:bg-[#1A1A1A] w-full py-8 px-6 shadow rounded-lg border border-gray-100 dark:border-dark-border-subtle">
          <form className="space-y-6" action={action}>
            ...
            <div>
              <button type="submit" className="bg-gray-800 w-full cursor-pointer p-1 text-white rounded-md" disabled={isPending}>Sign Up</button>
            </div>
          </form>
        </div>
      </div>
